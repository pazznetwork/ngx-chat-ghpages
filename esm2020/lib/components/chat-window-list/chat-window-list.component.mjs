...
ChatWindowListComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ChatWindowListComponent, deps: [{ token: i1.ChatListStateService }], target: i0.ɵɵFactoryTarget.Component });
