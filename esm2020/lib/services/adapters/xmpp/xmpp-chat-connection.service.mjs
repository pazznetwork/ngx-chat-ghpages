...
XmppChatConnectionService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.7", ngImport: i0, type: XmppChatConnectionService, deps: [{ token: i1.LogService }, { token: i0.NgZone }, { token: i2.XmppClientFactoryService }], target: i0.ɵɵFactoryTarget.Injectable });
