...
XmppChatAdapter.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.6", ngImport: i0, type: XmppChatAdapter, deps: [{ token: i1.XmppChatConnectionService }, { token: i2.LogService }, { token: i3.ContactFactoryService }], target: i0.ɵɵFactoryTarget.Injectable });
