...
ContactFactoryService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.7", ngImport: i0, type: ContactFactoryService, deps: [{ token: i1.LogService }], target: i0.ɵɵFactoryTarget.Injectable });
