...
class QueryStanzaBuilder extends AbstractStanzaBuilder {
    ...
    toStanza() {
        return xml('iq', Object.assign({ type: 'get' }, (this.to ? { to: this.to } : {})), xml('query', { xmlns: this.xmlns }));
    }
}
/**
...
class ServiceDiscoveryPlugin extends AbstractXmppPlugin {
    ...
    onBeforeOnline() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.discoverServices(this.chatAdapter.chatConnectionService.userJid.domain);
    ...
    supportsFeature(jid, searchedFeature) {
        return new Promise((resolve, reject) => {
            this.servicesInitialized$.pipe(first(value => !!value)).subscribe(() => __awaiter(this, void 0, void 0, function* () {
                try {
                    const service = this.resourceCache.get(jid) || (yield this.discoverServiceInformation(jid));
                    if (!service) {
    ...
    discoverServices(mainDomain) {
        return __awaiter(this, void 0, void 0, function* () {
            const serviceListResponse = yield this.chatAdapter.chatConnectionService.sendIq(new QueryStanzaBuilder(ServiceDiscoveryPlugin.DISCO_ITEMS, this.chatAdapter.chatConnectionService.userJid.domain).toStanza());
            const serviceDomains = new Set(serviceListResponse
                .getChild('query')
                .getChildren('item')
                .map((itemNode) => itemNode.attrs.jid));
            serviceDomains.add(mainDomain);
            const discoveredServices = yield Promise.all([...serviceDomains.keys()]
                .map((serviceDomain) => this.discoverServiceInformation(serviceDomain)));
            this.hostedServices.push(...discoveredServices);
        });
    }
    discoverServiceInformation(serviceDomain) {
        return __awaiter(this, void 0, void 0, function* () {
            const serviceInformationResponse = yield this.chatAdapter.chatConnectionService.sendIq(new QueryStanzaBuilder(ServiceDiscoveryPlugin.DISCO_INFO, serviceDomain).toStanza());
...
class Room {
    ...
    get nick() {
        var _a;
        return (_a = this.occupantJid) === null || _a === void 0 ? void 0 : _a.resource;
    }
    set nick(nick) {
    ...
    handleOccupantChangedNick(occupant, isCurrentUser, newNick) {
        ...
        if (!existingOccupant) {
            existingOccupant = Object.assign({}, occupant);
...
class ModifyAffiliationsOrRolesStanzaBuilder extends AbstractStanzaBuilder {
    ...
    buildItem(modification) {
        const { reason } = modification, attrs = __rest(modification, ["reason"]);
...
class MultiUserChatPlugin extends AbstractXmppPlugin {
    ...
    createRoom(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { presenceResponse, room } = yield this.joinRoomInternal(occupantJid);
            ...
            try {
                yield this.applyRoomConfiguration(room.roomJid, options);
    ...
    destroyRoom(roomJid) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                roomDestroyedResponse = yield this.xmppChatAdapter.chatConnectionService.sendIq(xml('iq', { type: 'set', to: roomJid.toString() }, xml('query', { xmlns: mucOwnerNs }, xml('destroy'))));
            }
            catch (e) {
    ...
    joinRoom(occupantJid) {
        return __awaiter(this, void 0, void 0, function* () {
            const { room } = yield this.joinRoomInternal(occupantJid);
            this.rooms$.next(this.rooms$.getValue());
            return room;
        });
    }
    getRoomInfo(roomJid) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const roomInfoResponse = yield this.xmppChatAdapter.chatConnectionService.sendIq(xml('iq', { type: 'get', to: roomJid.toString() }, xml('query', { xmlns: ServiceDiscoveryPlugin.DISCO_INFO })));
            const formEl = (_a = roomInfoResponse
                .getChild('query', ServiceDiscoveryPlugin.DISCO_INFO)) === null || _a === void 0 ? void 0 : _a.getChild('x', FORM_NS);
            if (formEl) {
    ...
    queryAllRooms() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = [];
            let roomQueryResponse = yield this.xmppChatAdapter.chatConnectionService.sendIq(xml('iq', { type: 'get', to }, xml('query', { xmlns: ServiceDiscoveryPlugin.DISCO_ITEMS })));
            ...
            while (resultSet && resultSet.getChild('last')) {
                ...
                roomQueryResponse = yield this.xmppChatAdapter.chatConnectionService.sendIq(xml('iq', { type: 'get', to }, xml('query', { xmlns: ServiceDiscoveryPlugin.DISCO_ITEMS }, xml('set', { xmlns: 'http://jabber.org/protocol/rsm' }, xml('max', {}, '250'), xml('after', {}, lastReceivedRoom)))));
                result.push(...this.extractRoomSummariesFromResponse(roomQueryResponse));
                resultSet = this.extractResultSetFromResponse(roomQueryResponse);
            }
            yield Promise.all(result.map((summary) => __awaiter(this, void 0, void 0, function* () {
                summary.roomInfo = yield this.getRoomInfo(summary.jid);
            })));
            return result;
        });
    }
    ...
    modifyAffiliationOrRole(roomJid, modification) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.xmppChatAdapter.chatConnectionService.sendIq(ModifyAffiliationsOrRolesStanzaBuilder.build(roomJid, [modification]));
        });
    }
     ...
     */
    getRoomConfiguration(roomJid) {
        return __awaiter(this, void 0, void 0, function* () {
            const configurationForm = yield this.xmppChatAdapter.chatConnectionService.sendIq(xml('iq', { type: 'get', to: roomJid.toString() }, xml('query', { xmlns: mucOwnerNs })));
    ...
    applyRoomConfiguration(roomJid, roomConfiguration) {
        return __awaiter(this, void 0, void 0, function* () {
            const roomConfigForm = yield this.getRoomConfiguration(roomJid);
            ...
            yield this.xmppChatAdapter.chatConnectionService.sendIq(xml('iq', { type: 'set', to: roomJid.toString() }, xml('query', { xmlns: mucOwnerNs }, serializeToSubmitForm(roomConfigForm))));
        });
    }
    getRoomByJid(jid) {
        return this.rooms$.getValue().find(room => room.roomJid.equals(jid.bare()));
    }
    banUser(occupantJid, roomJid, reason) {
        return __awaiter(this, void 0, void 0, function* () {
            const userJid = yield this.getUserJidByOccupantJid(occupantJid, roomJid);
            const response = yield this.modifyAffiliationOrRole(roomJid, {
    ...
    unbanUser(occupantJid, roomJid) {
        return __awaiter(this, void 0, void 0, function* () {
            const userJid = yield this.getUserJidByOccupantJid(occupantJid, roomJid);
            const banList = (yield this.getBanList(roomJid)).map(bannedUser => bannedUser.userJid);
            ...
            const response = yield this.modifyAffiliationOrRole(roomJid, { userJid, affiliation: Affiliation.none });
    ...
    getBanList(roomJid) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.xmppChatAdapter.chatConnectionService.sendIq(iq);
            return response.getChild('query').getChildren('item').map(item => {
                var _a;
                return ({
                    userJid: jid$1(item.attrs.jid),
                    affiliation: item.attrs.affiliation,
                    reason: (_a = item.getChild('reason')) === null || _a === void 0 ? void 0 : _a.getText(),
                });
            });
        });
    }
    inviteUser(inviteeJid, roomJid, invitationMessage) {
        return __awaiter(this, void 0, void 0, function* () {
            const from = this.xmppChatAdapter.chatConnectionService.userJid.toString();
            ...
            yield this.xmppChatAdapter.chatConnectionService.send(stanza);
        });
    }
    declineRoomInvite(occupantJid, reason) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    kickOccupant(nick, roomJid, reason) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.modifyAffiliationOrRole(roomJid, { nick, role: Role.none, reason });
            this.logService.debug(`kick occupant response: ${response.toString()}`);
            return response;
        });
    }
    changeUserNickname(newNick, roomJid) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    changeRoomSubject(roomJid, subject) {
        return __awaiter(this, void 0, void 0, function* () {
            const from = this.xmppChatAdapter.chatConnectionService.userJid.toString();
            yield this.xmppChatAdapter.chatConnectionService.send(xml('message', { to: roomJid.toString(), from, type: 'groupchat' }, xml('subject', {}, subject)));
    ...
    grantMembership(userJid, roomJid, reason) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.setAffiliation(userJid, roomJid, Affiliation.member, reason);
        });
    }
    revokeMembership(userJid, roomJid, reason) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.setAffiliation(userJid, roomJid, Affiliation.none, reason);
        });
    }
    grantAdmin(userJid, roomJid, reason) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.setAffiliation(userJid, roomJid, Affiliation.admin, reason);
        });
    }
    revokeAdmin(userJid, roomJid, reason) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.setAffiliation(userJid, roomJid, Affiliation.member, reason);
        });
    }
    grantModeratorStatus(occupantNick, roomJid, reason) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.setRole(occupantNick, roomJid, Role.moderator, reason);
        });
    }
    revokeModeratorStatus(occupantNick, roomJid, reason) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.setRole(occupantNick, roomJid, Role.participant, reason);
        });
    }
    ...
    handleRoomPresenceStanza(stanza) {
        ...
        if (stanzaType === 'unavailable') {
            const actor = (_a = itemEl.getChild('actor')) === null || _a === void 0 ? void 0 : _a.attrs.nick;
            const reason = (_b = itemEl.getChild('reason')) === null || _b === void 0 ? void 0 : _b.getText();
    ...
    joinRoomInternal(roomJid) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let roomInfo = null;
            try {
                roomInfo = yield this.getRoomInfo(occupantJid.bare());
            }
            catch (e) {
            ...
            try {
                const presenceResponse = yield this.xmppChatAdapter.chatConnectionService.sendAwaitingResponse(xml('presence', { to: occupantJid.toString() }, xml('x', { xmlns: mucNs })));
                ...
                if (roomInfo) {
                    room.name = (_a = getField(roomInfo, 'muc#roomconfig_roomname')) === null || _a === void 0 ? void 0 : _a.value;
                    room.description = ((_b = getField(roomInfo, 'muc#roominfo_description')) === null || _b === void 0 ? void 0 : _b.value) || '';
                }
    ...
    extractRoomSummariesFromResponse(iq) {
        var _a, _b;
        return ((_b = (_a = iq
            .getChild('query', ServiceDiscoveryPlugin.DISCO_ITEMS)) === null || _a === void 0 ? void 0 : _a.getChildren('item')) === null || _b === void 0 ? void 0 : _b.reduce((acc, item) => {
    ...
    handleRoomInvitationStanza(stanza) {
        var _a, _b, _c;
        const xEl = stanza.getChild('x', mucUserNs);
        const invitationEl = (_a = xEl.getChild('invite')) !== null && _a !== void 0 ? _a : xEl.getChild('decline');
        this.onInvitationSubject.next({
            type: invitationEl.name,
            roomJid: jid$1(stanza.attrs.from),
            roomPassword: (_b = xEl.getChild('password')) === null || _b === void 0 ? void 0 : _b.getText(),
            from: jid$1(invitationEl.attrs.from),
            message: (_c = invitationEl.getChild('reason')) === null || _c === void 0 ? void 0 : _c.getText(),
        });
        return true;
    }
    setAffiliation(occupantJid, roomJid, affiliation, reason) {
        return __awaiter(this, void 0, void 0, function* () {
            const userJid = yield this.getUserJidByOccupantJid(occupantJid, roomJid);
            return yield this.modifyAffiliationOrRole(roomJid, { userJid, affiliation, reason });
        });
    }
    setRole(occupantNick, roomJid, role, reason) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.modifyAffiliationOrRole(roomJid, { nick: occupantNick, role, reason });
        });
    }
    getUserJidByOccupantJid(occupantJid, roomJid) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            const users = yield this.queryUserList(roomJid);
            return (_b = (_a = users.find(roomUser => roomUser.userIdentifiers.find(ids => ids.nick === occupantJid.resource || ids.userJid.bare().equals(occupantJid.bare())))) === null || _a === void 0 ? void 0 : _a.userIdentifiers) === null || _b === void 0 ? void 0 : _b[0].userJid;
        });
    }
}
...
LogService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: LogService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
LogService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: LogService });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: LogService, decorators: [{
            type: Injectable
        }] });
...
XmppClientFactoryService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: XmppClientFactoryService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
XmppClientFactoryService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: XmppClientFactoryService });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: XmppClientFactoryService, decorators: [{
            type: Injectable
        }] });
...
class XmppChatConnectionService {
    ...
    sendPresence() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.send(xml('presence'));
        });
    }
    send(content) {
        return __awaiter(this, void 0, void 0, function* () {
            this.logService.debug('>>>', content);
            yield this.client.send(content);
        });
    }
    sendAwaitingResponse(request) {
        return new Promise((resolve, reject) => {
            request.attrs = Object.assign({ id: this.getNextRequestId(), from: this.userJid.toString() }, request.attrs);
    ...
    onStanzaReceived(stanza) {
        var _a;
        let handled = false;
        const [handleResponse] = (_a = this.stanzaResponseHandlers.get(stanza.attrs.id)) !== null && _a !== void 0 ? _a : [];
        if (handleResponse) {
    ...
    sendIq(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.sendAwaitingResponse(request);
    ...
    sendIqAckResult(id) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.send(xml('iq', { from: this.userJid.toString(), id, type: 'result' }));
        });
    }
    logIn(logInRequest) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    skipXmppClientResponses(stanza) {
        ...
        return ((_a = stanza.getChild('bind')) === null || _a === void 0 ? void 0 : _a.getNS()) === xmppBindNS;
    }
    logOut() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.client) {
                ...
                try {
                    yield this.send(xml('presence', { type: 'unavailable' }));
                }
                catch (e) {
...
XmppChatConnectionService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: XmppChatConnectionService, deps: [{ token: LogService }, { token: i0.NgZone }, { token: XmppClientFactoryService }], target: i0.ɵɵFactoryTarget.Injectable });
XmppChatConnectionService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: XmppChatConnectionService });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: XmppChatConnectionService, decorators: [{
            type: Injectable
...
ContactFactoryService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ContactFactoryService, deps: [{ token: LogService }], target: i0.ɵɵFactoryTarget.Injectable });
    ...
    logIn(logInRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.state$.getValue() === 'disconnected') {
                yield this.chatConnectionService.logIn(logInRequest);
            }
        });
    }
    logOut() {
    ...
    sendMessage(recipient, body) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (recipient.recipientType) {
                case 'room':
                    yield this.getPlugin(MultiUserChatPlugin).sendMessage(recipient, trimmedBody);
                    break;
                case 'contact':
                    ...
                    break;
                default:
                    throw new Error('invalid recipient type: ' + (recipient === null || recipient === void 0 ? void 0 : recipient.recipientType));
            }
        });
    }
    loadCompleteHistory() {
...
XmppChatAdapter.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: XmppChatAdapter, deps: [{ token: XmppChatConnectionService }, { token: LogService }, { token: ContactFactoryService }], target: i0.ɵɵFactoryTarget.Injectable });
...
ChatAvatarComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ChatAvatarComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
ChatAvatarComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "15.2.9", type: ChatAvatarComponent, selector: "ngx-chat-avatar", inputs: { imageUrl: "imageUrl" }, ngImport: i0, template: "<div class=\"chat-avatar\" [ngStyle]=\"{backgroundImage: 'url(' + imageUrl + ')'}\"></div>\n", styles: [".chat-avatar{border-radius:50%;background-size:cover;background-position:50%;background-repeat:no-repeat;width:100%;height:100%}\n"], dependencies: [{ kind: "directive", type: i2$1.NgStyle, selector: "[ngStyle]", inputs: ["ngStyle"] }] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ChatAvatarComponent, decorators: [{
            type: Component,
    ...
    onClick($event) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.linkOpener) {
                ...
                yield this.router.navigateByUrl(linkParser.pathname);
            }
        });
    }
    isInApp() {
...
ChatMessageLinkComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ChatMessageLinkComponent, deps: [{ token: i1$1.Router }, { token: i2$1.PlatformLocation }, { token: LINK_OPENER_TOKEN, optional: true }], target: i0.ɵɵFactoryTarget.Component });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ChatMessageLinkComponent, decorators: [{
        ...
        return [{ type: i1$1.Router }, { type: i2$1.PlatformLocation }, { type: undefined, decorators: [{
                        type: Optional
                    }, {
                        type: Inject,
...
ChatMessageTextComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ChatMessageTextComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
ChatMessageTextComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "15.2.9", type: ChatMessageTextComponent, selector: "ngx-chat-message-text", inputs: { text: "text" }, ngImport: i0, template: `{{text}}`, isInline: true, styles: [":host{white-space:pre-wrap}\n"] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ChatMessageTextComponent, decorators: [{
            type: Component,
...
ChatMessageComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ChatMessageComponent, deps: [{ token: CHAT_SERVICE_TOKEN }, { token: i1$2.HttpClient }, { token: CONTACT_CLICK_HANDLER_TOKEN, optional: true }], target: i0.ɵɵFactoryTarget.Component });
ChatMessageComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "15.2.9", type: ChatMessageComponent, selector: "ngx-chat-message", inputs: { showAvatars: "showAvatars", avatar: "avatar", message: "message", nick: "nick", contact: "contact", showMessageReadState: "showMessageReadState" }, ngImport: i0, template: "<ngx-chat-message-simple [mediaLink]=\"mediaLink\"\n                         [isImage]=\"isImage\"\n                         [isAudio]=\"isAudio\"\n                         [avatar]=\"getAvatar()\"\n                         [avatarInteractive]=\"message.direction === Direction.in\"\n                         (avatarClickHandler)=\"onContactClick()\"\n                         [direction]=\"message.direction\"\n                         [messageState]=\"getMessageState()\"\n                         [formattedDate]=\"message.datetime | date:chatService.translations.timeFormat\"\n                         [nick]=\"nick\">\n    <span [ngxChatLinks]=\"message.body\"></span>\n</ngx-chat-message-simple>\n", styles: [":host.chat-message--out{align-self:flex-end}:host.chat-message--in{align-self:flex-start}\n"], dependencies: [{ kind: "component", type: ChatMessageSimpleComponent, selector: "ngx-chat-message-simple", inputs: ["avatar", "avatarInteractive", "direction", "formattedDate", "footerHidden", "mediaLink", "isImage", "isAudio", "showImagePlaceholder", "messageState", "nick"], outputs: ["avatarClickHandler"] }, { kind: "directive", type: LinksDirective, selector: "[ngxChatLinks]", inputs: ["ngxChatLinks"] }, { kind: "pipe", type: i2$1.DatePipe, name: "date" }] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ChatMessageComponent, decorators: [{
            type: Component,
...
ChatMessageListRegistryService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ChatMessageListRegistryService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
ChatMessageListRegistryService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ChatMessageListRegistryService });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ChatMessageListRegistryService, decorators: [{
            type: Injectable
...
class ChatMessageListComponent {
    ...
    acceptRoomInvite(event) {
        return __awaiter(this, void 0, void 0, function* () {
            event.preventDefault();
            yield this.chatService.getPlugin(MultiUserChatPlugin).joinRoom(this.pendingRoomInvite.roomJid);
            this.recipient.pendingRoomInvite$.next(null);
            this.pendingRoomInvite = null;
        });
    }
    declineRoomInvite(event) {
        return __awaiter(this, void 0, void 0, function* () {
            event.preventDefault();
            yield this.chatService.getPlugin(MultiUserChatPlugin).declineRoomInvite(this.pendingRoomInvite.roomJid);
            this.recipient.pendingRoomInvite$.next(null);
            this.pendingRoomInvite = null;
            this.chatService.removeContact(this.recipient.jidBare.toString());
        });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ChatMessageListComponent, decorators: [{
        ...
        return [{ type: ChatListStateService }, { type: undefined, decorators: [{
                    ...
                    }] }, { type: i0.ChangeDetectorRef }, { type: ContactFactoryService }];
    }, propDecorators: { recipient: [{
                type: Input
            }], showAvatars: [{
                type: Input
...
class ChatWindowComponent {
    ...
    uploadFile(file) {
        return __awaiter(this, void 0, void 0, function* () {
            const url = yield this.fileUploadHandler.upload(file);
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ChatWindowListComponent, decorators: [{
            type: Component,
...
class UnreadMessageCountPlugin extends AbstractXmppPlugin {
    ...
    checkForUnreadCountChange(recipient) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.chatMessageListRegistry.isChatOpen(recipient)) {
                this.jidToLastReadTimestamp.set(recipient.jidBare.toString(), yield this.entityTimePlugin.getNow());
                yield this.persistLastSeenDates();
            }
    ...
    onBeforeOnline() {
        return __awaiter(this, void 0, void 0, function* () {
            const fetchedDates = yield this.fetchLastSeenDates();
    ...
    fetchLastSeenDates() {
        return __awaiter(this, void 0, void 0, function* () {
            const entries = yield this.publishSubscribePlugin.retrieveNodeItems(STORAGE_NGX_CHAT_LAST_READ_DATE);
    ...
    persistLastSeenDates() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.publishSubscribePlugin.storePrivatePayloadPersistent(STORAGE_NGX_CHAT_LAST_READ_DATE, 'current', lastReadNodeBuilder.toStanza());
        });
    }
    handlePubSubEvent(event) {
        const items = event.getChild('items');
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: RosterListComponent, decorators: [{
            type: Component,
...
class ChatComponent {
    ...
    set translations(translations) {
        ...
        if (translations) {
            this.chatService.translations = Object.assign(Object.assign(Object.assign({}, defaultTranslation), translations), { presence: Object.assign(Object.assign({}, defaultTranslation.presence), translations.presence) });
        }
    }
    ngOnInit() {
...
class EntityTimePlugin extends AbstractXmppPlugin {
    ...
    getNow() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.serverSupportsTime$.pipe(timeout$1(5000), first(supportsServerTime => supportsServerTime !== 'unknown'), mergeMap(supportsServerTime => supportsServerTime ? calculateNowViaServerTime$ : of(Date.now())), catchError(() => of(Date.now()))).toPromise();
        });
    }
...
class HttpFileUploadPlugin extends AbstractXmppPlugin {
    ...
    upload(file) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.uploadService;
            const { name, size, type } = file;
            const slotUrl = yield this.requestSlot(name, size.toString(), type);
            return yield this.uploadToSlot(slotUrl, file);
        });
    }
    isUploadSupported() {
        return this.fileUploadSupported;
    }
    requestSlot(filename, size, contentType) {
        return __awaiter(this, void 0, void 0, function* () {
            const to = (yield this.uploadService).jid;
            const slotResponse = yield this.xmppChatAdapter.chatConnectionService.sendIq(xml('iq', { to, type: 'get' }, xml('request', { xmlns: 'urn:xmpp:http:upload:0', filename, size, 'content-type': contentType })));
            return slotResponse.getChild('slot').getChild('put').attrs.url;
        });
    }
    uploadToSlot(slot, file) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.httpClient.put(slot, file, { responseType: 'blob' }).toPromise();
            return slot;
        });
    }
}
...
class MessageCarbonsPlugin extends AbstractXmppPlugin {
    ...
    onBeforeOnline() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.xmppChatAdapter.chatConnectionService.sendIq(xml('iq', { type: 'set' }, xml('enable', { xmlns: 'urn:xmpp:carbons:2' })));
        });
    }
    handleStanza(stanza) {
    ...
    handleCarbonMessageStanza(messageElement, receivedOrSent) {
        ...
        const body = (_a = messageElement.getChildText('body')) === null || _a === void 0 ? void 0 : _a.trim();
        const message = {
            body,
            direction,
            datetime: new Date(),
...
class PingPlugin extends AbstractXmppPlugin {
    ...
    ping() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield timeout(this.sendPing(), 10000);
    ...
    sendPing() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.xmppChatAdapter.chatConnectionService.sendIq(xml('iq', { type: 'get' }, xml('ping', { xmlns: 'urn:xmpp:ping' })));
        });
    }
    unschedulePings() {
...
ChatBackgroundNotificationService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ChatBackgroundNotificationService, deps: [{ token: CHAT_SERVICE_TOKEN }], target: i0.ɵɵFactoryTarget.Injectable });
ChatBackgroundNotificationService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ChatBackgroundNotificationService });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ChatBackgroundNotificationService, decorators: [{
            type: Injectable
        }], ctorParameters: function () {
        return [{ type: undefined, decorators: [{
                        type: Inject,
...
NgxChatModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: NgxChatModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
NgxChatModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "15.2.9", ngImport: i0, type: NgxChatModule, declarations: [ChatComponent,
        ...
        FileDropComponent,
        LinksDirective] });
NgxChatModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: NgxChatModule, imports: [CommonModule,
        HttpClientModule,
        FormsModule,
        TextFieldModule,
        RouterModule] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: NgxChatModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
